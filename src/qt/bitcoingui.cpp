                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PYMT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PYMT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PYMT: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PYMT Core"), this);
    aboutAction->setStatusTip(tr("Show information about PYMT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PYMT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PYMT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PYMT addresses"));
    ...
    openAction->setStatusTip(tr("Open a PYMT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PYMT Core help message to get a list with possible PYMT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PYMT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PYMT network", "", count));
}
...
{
    QString strTitle = tr("PYMT Core"); // default title
